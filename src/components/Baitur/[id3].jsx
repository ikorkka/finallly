      ...
      <div className={s.purchaseFirst__container}>
        <div className={s.purchaseFirst__body}>
          <div className={s.purchaseFirst__link}>
            ...
            <a href="#"> Смартфоны /</a>
            <a href="#"> Apple /</a>
            <span>Ноутбук Lenovo Ideapad 3 14ITL05 </span>
          </div>
          <div className={s.purchaseFirst__title}>
            <h1>Ноутбук Lenovo Ideapad 3 14ITL05</h1>
          </div>
                    ...
                    >
                      <div className={s.all_otziv}>
                        <div className={s.first_otziv}>
                          ...
                          ></Image>
                          <p>
                            Кратко говоря, это превосходное устройство, которое
                            полностью оправдало все мои ожидания.
                          </p>
                        </div>
                        <div className={s.second_otziv}>
                          ...
                          ></Image>
                          <p>
                            Качество сборки MacBook на высшем уровне. Корпус
                            изготовлен из высококачественного алюминия, что
                            придает ему прочность и элегантный внешний вид.
                          </p>
                        </div>
                        <div className={s.thre_otziv}>
                          ...
                          ></Image>
                          <p>
                            Производительность MacBook впечатляет. Он оснащен
                            мощным процессором,
                          </p>
                        </div>
                      </div>
              ...
              <div className={s.purchaseFirst__characteristic_info}>
                <div className={s.characteristic_info_first}>
                  ...
                  <div className={s.characteristic_info_first_btn}>
                    <button>Lenovo Ideapad 3 14ITL05</button>
                  </div>
                </div>
